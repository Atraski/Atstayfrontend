...
export default function Dropdown() {
    ...
    return (
        ...
        <div>
            <input type="text" className="desti" placeholder="Destination" style={{maxWidth:"150px" ,height:'0px' , marginTop:'13px' , padding:'15px' , border:'1px solid #000' , borderRadius:'20px'}}/>
